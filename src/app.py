...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and friendly meets in the school pool",
        "schedule": "Mondays and Wednesdays, 3:00 PM - 4:30 PM",
        "max_participants": 20,
        "participants": ["liam@mergington.edu", "zoe@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore painting, drawing, and collage activities",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions and problem-solving challenges",
